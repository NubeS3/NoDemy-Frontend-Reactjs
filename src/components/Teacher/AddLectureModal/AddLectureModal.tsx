...
import { AppBar, Box, Button, Checkbox, Divider, FormControlLabel, LinearProgress, Modal, TextField, Toolbar, Typography } from '@material-ui/core';
...
const AddLectureModal = ({
  ...
  const handleUpdateLecture = () => {
    updateLecture(lectureId, lectureName, canPreview === 'Yes' ? true : false, video);
  };
